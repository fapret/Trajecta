 ...
 * @generated
 */
public class AsignaturasItemProviderAdapterFactory extends AsignaturasAdapterFactory
	...
	public void dispose() {
		...
		if (creditsPlanItemProvider != null)
			creditsPlanItemProvider.dispose();
		if (facultyItemProvider != null)
		...
		if (someOfItemProvider != null)
			someOfItemProvider.dispose();
		if (notItemProvider != null)
			notItemProvider.dispose();
		if (coursedItemProvider != null)
			coursedItemProvider.dispose();
		if (examItemProvider != null)
			examItemProvider.dispose();
		if (creditsOnPlanItemProvider != null)
			creditsOnPlanItemProvider.dispose();
		if (creditsOnSubjectItemProvider != null)
			creditsOnSubjectItemProvider.dispose();
		if (subjectPlanItemProvider != null)
			subjectPlanItemProvider.dispose();
		if (registeredToItemProvider != null)
			registeredToItemProvider.dispose();
		if (courseItemProvider != null)
			courseItemProvider.dispose();
		if (examEvaluationItemProvider != null)
			examEvaluationItemProvider.dispose();
		if (evaluacionExamenItemProvider != null)
			evaluacionExamenItemProvider.dispose();
		if (courseEvaluationItemProvider != null)
