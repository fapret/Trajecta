 ...
 * </p>
 * <ul>
 *   <li>{@link Workspace.impl.WorkspaceImpl#getPassword <em>Password</em>}</li>
 *   <li>{@link Workspace.impl.WorkspaceImpl#getAsignaturas <em>Asignaturas</em>}</li>
 *   <li>{@link Workspace.impl.WorkspaceImpl#getEstudiante <em>Estudiante</em>}</li>
 *   <li>{@link Workspace.impl.WorkspaceImpl#getID <em>ID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkspaceImpl extends MinimalEObjectImpl.Container implements Workspace {
	...
	public Root getAsignaturas() {
		if (asignaturas != null && asignaturas.eIsProxy()) {
			...
			if (asignaturas != oldAsignaturas) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WorkspacePackage.WORKSPACE__ASIGNATURAS, oldAsignaturas, asignaturas));
			}
		}
		return asignaturas;
	}
	...
	public void setAsignaturas(Root newAsignaturas) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WorkspacePackage.WORKSPACE__ASIGNATURAS, oldAsignaturas, asignaturas));
	}
	...
	public Estudiantes.Root getEstudiante() {
		if (estudiante != null && estudiante.eIsProxy()) {
			...
			if (estudiante != oldEstudiante) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WorkspacePackage.WORKSPACE__ESTUDIANTE, oldEstudiante, estudiante));
			}
		}
		return estudiante;
	}
	...
	public void setEstudiante(Estudiantes.Root newEstudiante) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WorkspacePackage.WORKSPACE__ESTUDIANTE, oldEstudiante, estudiante));
	}
	...
	public void setID(String newID) {
		...
		id = newID;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WorkspacePackage.WORKSPACE__ID, oldID, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WorkspacePackage.WORKSPACE__PASSWORD:
				return getPassword();
			case WorkspacePackage.WORKSPACE__ASIGNATURAS:
				if (resolve) return getAsignaturas();
				return basicGetAsignaturas();
			case WorkspacePackage.WORKSPACE__ESTUDIANTE:
				if (resolve) return getEstudiante();
				return basicGetEstudiante();
			case WorkspacePackage.WORKSPACE__ID:
				return getID();
		}
