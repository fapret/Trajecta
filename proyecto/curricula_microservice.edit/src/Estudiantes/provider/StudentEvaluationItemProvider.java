 ...
 * @generated
 */
public class StudentEvaluationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StudentEvaluation_grade_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StudentEvaluation_grade_feature", "_UI_StudentEvaluation_type"),
				 EstudiantesPackage.Literals.STUDENT_EVALUATION__GRADE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_StudentEvaluation_evaluation_feature", "_UI_StudentEvaluation_type"),
				 EstudiantesPackage.Literals.STUDENT_EVALUATION__EVALUATION,
				 true,
				 false,
				 true,
				 null,
