 ...
 * @generated
 */
public class PlanInscriptionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PlanInscription_date_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PlanInscription_date_feature", "_UI_PlanInscription_type"),
				 EstudiantesPackage.Literals.PLAN_INSCRIPTION__DATE,
				 true,
				 false,
				 false,
	...
	protected void addPlanPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PlanInscription_Plan_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PlanInscription_Plan_feature", "_UI_PlanInscription_type"),
				 EstudiantesPackage.Literals.PLAN_INSCRIPTION__PLAN,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_PlanInscription_type") :
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EstudiantesPackage.Literals.PLAN_INSCRIPTION__PLAN_COURSE_INSCRIPTION,
