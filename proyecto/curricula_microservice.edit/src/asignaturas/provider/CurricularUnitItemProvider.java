 ...
 * @generated
 */
public class CurricularUnitItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CurricularUnit_Id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CurricularUnit_Id_feature", "_UI_CurricularUnit_type"),
				 AsignaturasPackage.Literals.CURRICULAR_UNIT__ID,
				 true,
				 false,
				 false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CurricularUnit_Name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CurricularUnit_Name_feature", "_UI_CurricularUnit_type"),
				 AsignaturasPackage.Literals.CURRICULAR_UNIT__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addCredPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CurricularUnit_Cred_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CurricularUnit_Cred_feature", "_UI_CurricularUnit_type"),
				 AsignaturasPackage.Literals.CURRICULAR_UNIT__CRED,
				 true,
				 false,
				 false,
	...
	protected void addValidPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CurricularUnit_Valid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CurricularUnit_Valid_feature", "_UI_CurricularUnit_type"),
				 AsignaturasPackage.Literals.CURRICULAR_UNIT__VALID,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_CurricularUnit_type") :
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AsignaturasPackage.Literals.CURRICULAR_UNIT__REQUIREMENT,
		...
		newChildDescriptors.add
			(createChildParameter
				(AsignaturasPackage.Literals.CURRICULAR_UNIT__COURSE,
				 AsignaturasFactory.eINSTANCE.createCourse()));

		newChildDescriptors.add
			(createChildParameter
				(AsignaturasPackage.Literals.CURRICULAR_UNIT__EXAM_EVALUATION,
