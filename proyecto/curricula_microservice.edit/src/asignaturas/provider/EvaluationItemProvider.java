...
/**
 * This is the item provider adapter for a {@link asignaturas.Evaluation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EvaluationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Evaluation_date_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Evaluation_date_feature", "_UI_Evaluation_type"),
				 AsignaturasPackage.Literals.EVALUATION__DATE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Date labelValue = ((Evaluation)object).getDate();
