...
/**
 * This is the item provider adapter for a {@link asignaturas.Career} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CareerItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AsignaturasPackage.Literals.CAREER__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AsignaturasPackage.Literals.CAREER__PLAN);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AsignaturasPackage.Literals.CAREER__PLAN,
				 AsignaturasFactory.eINSTANCE.createCreditsPlan()));

		newChildDescriptors.add
			(createChildParameter
				(AsignaturasPackage.Literals.CAREER__PLAN,
				 AsignaturasFactory.eINSTANCE.createSubjectPlan()));
	}
