...
public class SubjectItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addSubjectCurricularUnitPropertyDescriptor(object);
		}
	...
	protected void addMinCreditsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Subject_MinCredits_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Subject_MinCredits_feature", "_UI_Subject_type"),
				 AsignaturasPackage.Literals.SUBJECT__MIN_CREDITS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Subject Curricular Unit feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSubjectCurricularUnitPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Subject_SubjectCurricularUnit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Subject_SubjectCurricularUnit_feature", "_UI_Subject_type"),
				 AsignaturasPackage.Literals.SUBJECT__SUBJECT_CURRICULAR_UNIT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AsignaturasPackage.Literals.SUBJECT__GROUP_OF_SUBJECTS,
