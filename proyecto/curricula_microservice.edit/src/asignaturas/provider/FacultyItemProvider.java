 ...
 * @generated
 */
public class FacultyItemProvider 
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AsignaturasPackage.Literals.FACULTY__CAREERS,
				 AsignaturasFactory.eINSTANCE.createCareer()));

		newChildDescriptors.add
			(createChildParameter
				(AsignaturasPackage.Literals.FACULTY__FACULTY_CU,
