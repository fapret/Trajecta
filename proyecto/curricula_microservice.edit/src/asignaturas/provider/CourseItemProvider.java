		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AsignaturasPackage.Literals.COURSE__YEAR,
				 true,
				 false,
				 false,
	...
	protected void addEditionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Course_Edition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Course_Edition_feature", "_UI_Course_type"),
				 AsignaturasPackage.Literals.COURSE__EDITION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
