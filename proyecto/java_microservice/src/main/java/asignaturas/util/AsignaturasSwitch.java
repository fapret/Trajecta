...
public class AsignaturasSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case AsignaturasPackage.COURSED: {
			...
			if (result == null)
				result = caseRequirement(coursed);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case AsignaturasPackage.CREDITS_ON_PLAN: {
			...
			if (result == null)
				result = caseRequirement(creditsOnPlan);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AsignaturasPackage.CREDITS_ON_SUBJECT: {
			...
			if (result == null)
				result = caseRequirement(creditsOnSubject);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case AsignaturasPackage.REGISTERED_TO: {
			...
			if (result == null)
				result = caseRequirement(registeredTo);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case AsignaturasPackage.EXAM_EVALUATION: {
			...
			if (result == null)
				result = caseEvaluation(examEvaluation);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AsignaturasPackage.EVALUACION_EXAMEN: {
			...
			if (result == null)
				result = caseEvaluation(evaluacionExamen);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AsignaturasPackage.COURSE_EVALUATION: {
			...
			if (result == null)
				result = caseEvaluation(courseEvaluation);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AsignaturasPackage.PARTIAL_EVALUATION: {
			PartialEvaluation partialEvaluation = (PartialEvaluation) theEObject;
			T result = casePartialEvaluation(partialEvaluation);
			if (result == null)
				result = caseEvaluation(partialEvaluation);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Partial Evaluation</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Partial Evaluation</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
