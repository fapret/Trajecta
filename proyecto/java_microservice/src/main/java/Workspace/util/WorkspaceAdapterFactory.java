...
public class WorkspaceAdapterFactory extends AdapterFactoryImpl {
	...
	protected WorkspaceSwitch<Adapter> modelSwitch =
		new WorkspaceSwitch<Adapter>() {
			@Override
			public Adapter caseRootWorkspaces(RootWorkspaces object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link Workspace.RootWorkspaces <em>Root Workspaces</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createRootWorkspacesAdapter() {
		return null;
	}
