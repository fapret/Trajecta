...
const selectDegreeBtn = document.getElementById("markDegree");

selectDegreeBtn.disabled = true;
...
allCareersSelect.addEventListener("change", () => {
    ...
    selectDegreeBtn.disabled = false;
});
selectDegreeBtn.addEventListener("click", () => {
    agregar_titulo();
});